...
const Results = ({ analysis, recommendations }) => {
  ...
  const handleRetakeTest = () => {
    if (
      window.confirm(
        "Are you sure you want to retake the test? Your current results will be lost."
      )
    ) {
          ...
          <div className="profile-card">
            ...
            <div className="personality-type">
              <span className="type-badge">
                {analysis.profile.personalityType.type}
              </span>
              <p className="type-description">
                {analysis.profile.personalityType.description}
              </p>
            </div>
            ...
            <div className="modal-body">
              <section className="modal-section">
                ...
                <p className="personalized-insight">
                  {selectedCareer.personalizedInsight}
                </p>
              </section>
                ...
                <section className="modal-section">
                  ...
                  {selectedCareer.transitionFrom && (
                    <p className="transition-note">
                      <strong>Common transitions from:</strong>{" "}
                      {selectedCareer.transitionFrom.join(", ")}
                    </p>
                  )}
                </section>
              )}
              ...
              <section className="modal-section">
                ...
                <div className="overview-grid">
                  ...
                  <div className="overview-item">
                    ...
                    <span className="overview-value">
                      {selectedCareer.industries.join(", ")}
                    </span>
                  </div>
                </div>
              </section>
